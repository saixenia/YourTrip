...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView = (EditText) findViewById(R.id.Txt_contraseña);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.Btn_ingresar);
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            mPasswordView.setError(getString(R.string.error_invalido_contraseña));
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError(getString(R.string.error_invalido_correo));
            focusView = mEmailView;
            cancel = true;
        }
